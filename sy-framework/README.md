...
- 在线演示 ：  [http://boot.sy.org](http://boot.sy.org)

- 在线文档：  [http://doc.sy.com/1273753](http://doc.sy.com/1273753)

- 常见问题：  [入门常见问题大全](http://www.sy.org/forum.php?mod=viewthread&tid=7816&extra=page%3D1)
...
```
	...
	public Result<IPage<SyDemo>> list(SyDemo syDemo, @RequestParam(name = "pageNo", defaultValue = "1") Integer pageNo, 
	                                     @RequestParam(name = "pageSize", defaultValue = "10") Integer pageSize,
			HttpServletRequest req) {
		Result<IPage<SyDemo>> result = new Result<IPage<SyDemo>>();
		
		//调用QueryGenerator的initQueryWrapper
		QueryWrapper<SyDemo> queryWrapper = QueryGenerator.initQueryWrapper(syDemo, req.getParameterMap());
		
		Page<SyDemo> page = new Page<SyDemo>(pageNo, pageSize);
		IPage<SyDemo> pageList = syDemoService.page(page, queryWrapper);
...
> 功能说明：   一键生成的代码（包括：controller、service、dao、mapper、entity、vue）
 ...
 - 模板位置： src/main/resources/sy/code-template
 - 技术文档： http://doc.sy.com
