package org.sy.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws SyFrameWorkException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws SyFrameWorkException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new SyFrameWorkException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key,SysUserCacheInfo user) {
		if(user==null) {
			user = SyDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
