package org.sy.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang.StringUtils;
import org.sy.common.util.RestUtil;
...
@Slf4j
@Component
public class SyElasticsearchTemplate {
    ...
    public SyElasticsearchTemplate(@Value("${sy.elasticsearch.cluster-nodes}") String baseUrl) {
        log.debug("SyElasticsearchTemplate BaseURL：" + baseUrl);
