package org.sy.common.system.query;
...
public class QueryGenerator {
	 ...
	 * <br>错误示例:如QueryWrapper<SyDemo> queryWrapper = new QueryWrapper<SyDemo>(syDemo);
	 * <br>正确示例:QueryWrapper<SyDemo> queryWrapper = new QueryWrapper<SyDemo>();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list =SyDataAutorUtils.loadDataSearchConditon();
