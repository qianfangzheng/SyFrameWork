...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://127.0.0.1:8080/sy-framework/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8080/sy-framework/test/syDemo/getPdfUrl?title="+encodeURI(title));
