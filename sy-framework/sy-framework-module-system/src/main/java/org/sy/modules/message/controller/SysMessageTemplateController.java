package org.sy.modules.message.controller;
...
public class SysMessageTemplateController extends SyController<SysMessageTemplate, ISysMessageTemplateService> {
	@Autowired
