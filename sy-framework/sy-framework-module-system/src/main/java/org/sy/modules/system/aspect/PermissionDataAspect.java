package org.sy.modules.system.aspect;
...
import org.sy.common.aspect.annotation.PermissionData;
import org.sy.common.system.util.SyDataAutorUtils;
import org.sy.common.system.util.JwtUtil;
import org.sy.common.system.vo.SysPermissionDataRuleModel;
import org.sy.common.system.vo.SysUserCacheInfo;
...
import org.sy.modules.system.entity.SysPermissionDataRule;
import org.sy.modules.system.service.ISysPermissionDataRuleService;
import org.sy.modules.system.service.ISysPermissionService;
...
public class PermissionDataAspect {
	...
	@Pointcut("@annotation(org.sy.common.aspect.annotation.PermissionData)")
	...
	public Object arround(ProceedingJoinPoint point) throws  Throwable{
		...
		if(currentSyspermission!=null && currentSyspermission.size()>0) {
			...
			if(dataRules!=null && dataRules.size()>0) {
				SyDataAutorUtils.installDataSearchConditon(request, dataRules);
				SysUserCacheInfo userinfo = sysUserService.getCacheUser(username);
				SyDataAutorUtils.installUserInfo(request, userinfo);
			}
		}
