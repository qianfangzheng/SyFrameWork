package org.sy.modules.quartz.service.impl;

import java.util.List;

import org.sy.common.constant.CommonConstant;
import org.sy.common.exception.SyFrameWorkException;
import org.sy.modules.quartz.entity.QuartzJob;
import org.sy.modules.quartz.mapper.QuartzJobMapper;
import org.sy.modules.quartz.service.IQuartzJobService;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new SyFrameWorkException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new SyFrameWorkException(e.getMessage(), e);
		}catch (Exception e) {
			throw new SyFrameWorkException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String jobClassName) {
		try {
			...
			throw new SyFrameWorkException("删除定时任务失败");
		}
	}
