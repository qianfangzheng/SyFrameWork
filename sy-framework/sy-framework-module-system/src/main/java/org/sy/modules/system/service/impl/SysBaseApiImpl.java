package org.sy.modules.system.service.impl;
...
import org.sy.common.constant.DataBaseConstant;
import org.sy.common.exception.SyFrameWorkException;
import org.sy.common.system.api.ISysBaseAPI;
import org.sy.common.system.vo.ComboModel;
import org.sy.common.system.vo.DictModel;
import org.sy.common.system.vo.LoginUser;
import org.sy.common.system.vo.SysDepartModel;
import org.sy.common.util.IPUtils;
import org.sy.common.util.SpringContextUtils;
...
import org.sy.modules.message.websocket.WebSocket;
import org.sy.modules.system.entity.*;
import org.sy.modules.system.mapper.*;
import org.sy.modules.system.service.ISysDepartService;
import org.sy.modules.system.service.ISysDictService;
...
public class SysBaseApiImpl implements ISysBaseAPI {
    ...
    public String parseTemplateByCode(String templateCode,Map<String, String> map) {
        ...
        if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
            throw new SyFrameWorkException("消息模板不存在，模板编码："+templateCode);
        }
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new SyFrameWorkException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
