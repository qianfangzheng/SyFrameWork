package org.sy.modules.ngalain.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import org.sy.common.util.MD5Util;
import org.sy.common.util.oConvertUtils;
import org.sy.modules.ngalain.mapper.NgAlainMapper;
import org.sy.modules.ngalain.service.NgAlainService;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    @Override
    public JSONArray getSyMenu(String id) throws Exception {
        ...
        JSONObject syMenu = new JSONObject();
        syMenu.put("text", "sy菜单");
        syMenu.put("group",true);
        syMenu.put("children", menulist);
        JSONArray syMenuList=new JSONArray();
        syMenuList.add(syMenu);
        return syMenuList;
    }
