package org.sy.modules.message.job;

import java.util.List;

import org.sy.common.util.DateUtils;
import org.sy.modules.message.entity.SysMessage;
import org.sy.modules.message.handle.ISendMsgHandle;
import org.sy.modules.message.handle.enums.SendMsgStatusEnum;
import org.sy.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" sy-framework 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
