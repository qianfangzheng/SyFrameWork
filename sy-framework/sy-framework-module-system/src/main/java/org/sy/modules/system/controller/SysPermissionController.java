...
import org.sy.common.util.MD5Util;
...
import org.sy.modules.system.entity.SysRolePermission;
import org.sy.modules.system.model.SysPermissionTree;
...
import org.sy.modules.system.service.ISysRolePermissionService;
import org.sy.modules.system.util.PermissionDataUtil;
...
//	}
	...
	/**
	 * 判断是否外网URL 例如： http://localhost:8080/sy-framework/swagger-ui.html#/ 支持特殊格式： {{
